                        ...
                        <div class="row"><!-- INICIO PRIMERA ROW -->  
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input  type="text"  value ="<?php echo $var6; ?>" class="form-control"  maxlength="50" minlength="5"   autocomplete = "off" type="text"  placeholder="Ingrese la pregunta" name="pregunta" id="pregunta">
                                </div>
                            </div>
