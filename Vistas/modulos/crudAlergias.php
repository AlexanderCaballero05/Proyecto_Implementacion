      ...
      <div class="row">
        ...
        <?php
         ...
         $usuario=$_SESSION['vario'];
          ...
          <button  data-toggle="modal"  href="#AGREGAR_ALERGIA" type='button' id="btnGuardar"  style="color:white;"class="btn btn-primary mb-3"><span> <i class="nav-icon fa fa-plus-square mx-1"></i></span>Agregar</button>
