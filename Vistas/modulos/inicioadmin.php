    ...
    <div class="row">	
     ...
     <div class="col-lg-4 col-xs-7">
      <div class="info-box bg-info">
        <span class="info-box-icon"><i class="fa fa-child"></i></span>
        <div class="info-box-content">
          <span class="info-box-text">Psicólogos registrados</span>
     ...
     <div class="col-lg-4 col-xs-7">
      ...
      <span class="info-box-icon"><i class="fa fa-child"></i></span>
        <div class="info-box-content">
          <span class="info-box-text">Administradores registrados</span>
          <span class="info-box-number"><?php echo $admin ?></span>
          <!-- The progress section is optional -->
          <div class="progress">
            <div class="progress-bar" style="width:<?php echo $porventa?>%"></div>
     ...
     <div class="col-lg-4 col-xs-7">
      ...
      <span class="info-box-icon"><i class="fa fa-child"></i></span>
        <div class="info-box-content">
          <span class="info-box-text">Enfermeros registrados</span>
