      ...
      <div class="row">
        <div class="col-md-12">
          ...
          ?> 
            ...
            <button  data-toggle="modal"  href="#AGREGAR_EXAMEN" type='button' id="btnGuardar"  style="color:white;"class="btn btn-primary mb-3"><span> <i class="nav-icon fa fa-plus-square mx-1"></i></span>Agregar</button>
