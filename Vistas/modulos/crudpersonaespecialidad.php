                ...
                <div class="table-responsive">
                  <table id="tabla_personaespecialidad" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <!--INICIO DEL MODAL DE EDITAR NUEVA ESPECIALIDAD -->
                                ...
                                <form id="FORMEDITRAPERSONAS" method="POST">
                                  ...
                                  <div class="modal-body"><!--CUERPO DEL MODAL -->
                                    <div class="row"><!-- INICIO PRIMERA ROW -->  
                                      <input type="number" value ="<?php echo $var1; ?>" hidden class="form-control" name="id_especialidad" id="id_especialidad">
                                      <div class="col-sm-12">
                                        <div class="form-group">
                                          <label for="txtcodigo_persona">Nombre</label>
                                          <input  type="text"  value ="<?php echo $var2; ?>" class="form-control"  maxlength="50"     autocomplete = "off" type="text"   name="editar_nombre" id="editar_nombre">
                                        </div>
                                      </div>
                                      <div class="col-sm-12">
                                        <div class="form-group">
                                         <label for="BASICOS" class="control-label">Especialidad</label> 
                                          <select  stye="width: 100%;"  class="form-control select2" name="EDITARESPECIALIDAD" id="EDITARESPECIALIDAD" type="text" aria-placeholder="Buscar" required >
                                          <option hidden value="<?php echo $var3?>"> <?php echo $var3 ?></option>
                                                  <?php 
                                                    if ($result4->num_rows > 0) {
                                                    while($row4 = $result4->fetch_assoc()) { 
                                                    $codigo = $row4['CODIGO_ESPECIALIDAD'];
                                                    $nombre = $row4['NOMBRE'];
                                                    ?>
                                  ...
                                  <div class="modal-footer ">
                                    ...
                                    <button type="submit" id="editar_especialidad" name="editar_especialidad" class="btn btn-success"><span> <i class="nav-icon fas fa-save mx-1"></i></span>Guardar</button>      
                              ...
                              <div class="modal-content">
                                ...
                                <form id="FORMEeliminar" method="POST">
                                  <div class="modal-body">
                                    ...
                                    <h4 class="text-center">¿Esta seguro de eliminar la persona especialidad<?php echo $var2; ?>?</h4>
