...
<div class="content-wrapper">
    ...
    <div class="content-header text-xl-center mb-3 btn-light">
              <h4>HISTORIAL DE TUTORIAS DE LOS ESTUDIANTES DE PROSECAR </h4>
    </div>
    <section class="content">
       ...
       <div class="card-header" style="background-color:#B3F2FF;">
          <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
            <a class=" nav-link " style="color:#000000;" href="matriculaestudiantes">TUTORIAS ACTUALES</a>
            </li>
            <li class="nav-item">
            <a class=" nav-link active" style="color:#000000;" href="">HISTORIAL DE TUTORIAS</a>
            </li>
          </ul>
        </div>
