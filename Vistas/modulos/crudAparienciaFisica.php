    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-10">
            ...
            <button  data-toggle="modal"  href="#AGREGAR" type='button' id="btnGuardar"  style="color:white;"class="btn btn-primary mb-3">Agregar Apariencia</button>
          ...
          <div class="card card-primary">
            <div class="card-header text-center" style="background-color: #0CCDE3"><!-- TITULO ENCABEZADO DATOS PERSONALES -->
               <h1 class=" card-title text-center"><strong style="color:black;">Apariencia Fisica</strong></h1>
            </div>
       ...
       <div class="modal-dialog modal-md">
           <div class="modal-content"><!-- Modal content-->
                <form id="FORMEDITARMODA" method="POST">
                    <div class="modal-header" style="background-color: #0CCDE3">
                        <h4 class="text-center">AGREGAR  APARIENCIA FISICA</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
