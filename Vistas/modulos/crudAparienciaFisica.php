        ...
        <div class="col-md-12">
                        ...
                        <?php
                            ...
                            <?php
                             ...
                             ?>
            <button  data-toggle="modal"  href="#AGREGAR" type='button' id="btnGuardar"  style="color:white;"class="btn btn-primary mb-3"><span> <i class="nav-icon fa fa-plus-square mx-1"></i></span>Agregar</button>
