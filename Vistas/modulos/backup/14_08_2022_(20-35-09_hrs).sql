...
CREATE TABLE `tbl_bitacora_sistema` (
  ...
  `CODIGO_OBJETO` int(5) NOT NULL,
  `CODIGO_REGISTRO` int(5) NOT NULL,
  `TABLA` varchar(100) DEFAULT NULL,
  `CAMPO` varchar(100) DEFAULT NULL,
  `ACTIVIDAD` varchar(100) DEFAULT NULL,
  `VALORA_ACTUAL` varchar(100) DEFAULT NULL,
  `VALOR_ANTERIOR` varchar(100) DEFAULT NULL,
  `FECHA` date DEFAULT NULL,
  PRIMARY KEY (`CODIGO_BITACORA`),
  KEY `CO_USUARIO` (`CODIGO_USUARIO`),
  KEY `COdig_OBJETO` (`CODIGO_OBJETO`),
  CONSTRAINT `CO_USUARIO` FOREIGN KEY (`CODIGO_USUARIO`) REFERENCES `tbl_usuario` (`CODIGO_USUARIO`),
  CONSTRAINT `COdig_OBJETO` FOREIGN KEY (`CODIGO_OBJETO`) REFERENCES `tbl_objetos` (`CODIGO_OBJETO`)
...
INSERT INTO tbl_especialidad VALUES("4","PEDIATRIA","2","ATENCIÓN A MENORES DE EDAD","","0000-00-00","0000-00-00","");
INSERT INTO tbl_especialidad VALUES("5","PSICOLOGIA COGNITIVA CONDUCTUAL","3","ÁREA PSICOLOGÍA","","0000-00-00","0000-00-00","");
...
INSERT INTO tbl_objetos VALUES("55","USUARIOS","OBJETO GESTIÓN DE USUARIOS","ADMIN","2022-08-13","0000-00-00","");
...
INSERT INTO tbl_preguntas VALUES("5","2","¿NOMBRE DE TU MASCOTA FAVORITA?"," ADMIN","2022-07-18","","0000-00-00");
INSERT INTO tbl_preguntas VALUES("6","2","¿UN JUGADOR DE FUTBOL FAVORITO?"," ADMIN","2022-07-18","","0000-00-00");
INSERT INTO tbl_preguntas VALUES("7","2","¿COLOR DE ROPA FAVORITO?"," ADMIN","2022-07-18","","0000-00-00");
...
INSERT INTO tbl_tutoria VALUES("1","1","ESPAÑOL","RUT","2022-07-27","0000-00-00","");
INSERT INTO tbl_tutoria VALUES("2","4","COMUNIÓN","LUZ","2022-07-27","0000-00-00","");
...
INSERT INTO tbl_tutoria VALUES("8","1","BIOLOGÍA ","ADMIN","2022-08-03","0000-00-00","");
