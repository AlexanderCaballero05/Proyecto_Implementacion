...
INSERT INTO tbl_inscripcion_cita VALUES("1","2","1","0000-00-00","00:20:22","0000-00-00","2022-03-27","","");
...
INSERT INTO tbl_objetos VALUES("32","GESTION_DE_CITAS","DED","","2022-03-27","","");
...
INSERT INTO tbl_parametros_usuarios VALUES("16","44","1","1","","0000-00-00","","0000-00-00");
...
INSERT INTO tbl_persona VALUES("43","SAMUEL","JOSUE","AMADOR","HERRERA","2147483647","1999-10-04","distrito","EN UNA CASITA,CON SU MICHI UWU","2022-03-23","0000-00-00","6","ADMIN","0000-00-00","","0000-00-00","2");
INSERT INTO tbl_persona VALUES("44","FRANCSICO","PABLO","PADILLA","PAVON","08011992258","2013-02-01","","Tegucigalpa","2022-03-02","","7","","0000-00-00","","0000-00-00","");
...
CREATE TABLE `tbl_receta_medica` (
  ...
  `CODIGO_EXPEDIENTE_MEDICO` int(11) DEFAULT NULL,
  ...
  KEY `FK_CODIGO_EXPEDIENTE_MEDICO` (`CODIGO_EXPEDIENTE_MEDICO`),
  KEY `FK_CODIGO_MEDICAMENTO` (`CODIGO_MEDICAMENTO`),
  CONSTRAINT `FK_CODIGO_EXPEDIENTE_MEDICO` FOREIGN KEY (`CODIGO_EXPEDIENTE_MEDICO`) REFERENCES `tbl_expediente_medico_historico` (`CODIGO_EXPEDIENTE_MEDICO`),
...
INSERT INTO tbl_usuario VALUES("41","35","","LUISILLO","2","1","Luis123**","0000-00-00","0","0","0000-00-00","","2022-02-25","41","0000-00-00");
