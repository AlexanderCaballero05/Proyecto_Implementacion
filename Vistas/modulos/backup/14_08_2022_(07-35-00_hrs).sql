...
CREATE TABLE `tbl_bitacora_sistema` (
  `CODIGO_BITACORA` int(10) NOT NULL AUTO_INCREMENT,
  `CODIGO_USUARIO` int(5) NOT NULL,
  `CODIGO_OBJETO` int(5) NOT NULL,
  `CODIGO_REGISTRO` int(5) DEFAULT NULL,
  ...
  KEY `COD_USUARIO` (`CODIGO_USUARIO`),
  KEY `COD_OBJETO` (`CODIGO_OBJETO`),
  CONSTRAINT `COD_OBJETO` FOREIGN KEY (`CODIGO_OBJETO`) REFERENCES `tbl_objetos` (`CODIGO_OBJETO`),
  CONSTRAINT `COD_USUARIO` FOREIGN KEY (`CODIGO_USUARIO`) REFERENCES `tbl_usuario` (`CODIGO_USUARIO`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;

INSERT INTO tbl_bitacora_sistema VALUES("1","1","1","1","np","mo","mp","mo","2022-08-14");
...
INSERT INTO tbl_objetos VALUES("55","USUARIOS","OBJETO GESTIÃ“N DE USUARIOS","ADMIN","2022-08-13","","");
...
INSERT INTO tbl_persona VALUES("2","DIANA","RUT","GARCIAQ","AMADOR","0801200012391","F","2000-06-16","FRANCISCO MORAZAN","EN UNA CASITA :3","2022-07-26","","1","ADMIN","0000-00-00","","");
...
INSERT INTO tbl_usuario VALUES("2","2","RUT","2","1","$2a$07$usesomesillystringforeCFgULGhtYgEopegGdjbjYiHOQCeHz.S","","ADMIN","2022-07-26","2022-08-14","ADMIN","");
...
INSERT INTO tbl_usuario VALUES("9","9","DAVID","2","8","$2a$07$usesomesillystringforeK2F0CA.OyIc/hzje/abe5/.lBawI8Ca","","CESAR","2022-07-27","2022-08-14","ADMIN","");
