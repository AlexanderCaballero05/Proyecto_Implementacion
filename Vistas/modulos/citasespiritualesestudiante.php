...
<div class="content-wrapper">
    ...
    <div class="content-header text-xl-center mb-3 btn-light">
              <h4>Citas Espirituales Pendientes Estudiante  Prosecar </h4>
    </div>
    <section class="content">
       ...
       <div class="card-header" style="background-color:#B3F2FF;">
          <ul class="nav nav-tabs card-header-tabs">
            ...
            <li class="nav-item">
            <a class=" nav-link active" style="color:#000000;" href="">Citas Espirituales</a>
            </li>
          </ul>
        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <div class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <a>
                                                                <form method="POST"
                                                                 action="Reportes_Prosecar/reporteindividualespiritual.php"
                                                                  target="_blank"> 
...
<script>
    function Descargar() {
      window.open('Reportes_Prosecar/reportecitasespirituales.php','_blank');
