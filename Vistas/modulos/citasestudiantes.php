...
$codigoObjeto =63;///cambiar
$accion = 'INGRESO A LA PANTALLA DE MANTENIMIENTO DE CITAS MEDICAS ESTUDIANTES';
$descripcion = 'MANTENIMIENTO A LAS CITAS MÉDICAS ESTUDIANTE ';
    ...
    <section class="content">
       ...
       <div class="card-header" style="background-color:#B3F2FF;">
          <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item">
            <a class=" nav-link active" style="color:#000000;" href="">Citas Médicas</a>
            </li>
            <li class="nav-item">
            <a class=" nav-link" style="color:#000000;" href="citaspsicologicaestudiante">Citas Psicológicas</a>
            </li>
            <li class="nav-item">
                                                    ...
                                                    <div class="text-center">
                                                        <div class="btn-group">
                                                            <!--Codigo para asignar permiso del boton de editar --> 
                                                                <a>
                                                                <form method="POST"
                                                                 action="Reportes_Prosecar/reporteindividualmedicas.php"
                                                                  target="_blank"> 
...
<script>
    function Descargar() {
      window.open('Reportes_Prosecar/reportecitaestumedico.php','_blank');
