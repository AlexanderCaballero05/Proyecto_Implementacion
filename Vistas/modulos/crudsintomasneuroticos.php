...
<div class="content-wrapper">
  ...
  <section class="content-header text-xl-center mb-3 btn-light">
              <h4>MANTENIMIENTO SINTOMAS NEUROTICOS </h4>
        </section>
        ...
        <div class="col-md-12">
                         <?php
                            ...
                            if($row > 0){
                                ...
                                $evaluar_permiso->execute(array($usuariomo, '47'));
                              ...
                              <div class="btn-group">
                               ...
                               <?php
                                  ...
                                  if($row > 0){
                                      ...
                                      $evaluar_permiso_eliminar->execute(array($usuariomo, '47'));
                               ...
                               <?php
                                ...
                                <?php
                                  ...
                                  $evaluar_permiso_actualizar->execute(array($usuariomo, '47'));
