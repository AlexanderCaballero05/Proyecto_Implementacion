  ...
  <div class="content-header">
    <div class="container-fluid">
      ...
      <div class="card"> <!--card del menu-->
        ...
        <button  type="submit" title='Imprimir'     name="re_tutor" id="btnGuardar"  style="color:white; background-color:#FA0079 " class="btn btn-danger mb-3"> <span><i class="nav-icon fa fa-file-pdf mx-1"></i></span>Reporte</button>
        </form>
