...
?>
<?php
  if (isset($_POST['estu_codigo'])) {
       $estudiante =($_POST['estu_codigo']);
       $codigo_persona =($_POST['persona_codigo']);
    }  
 ?>
        ...
        <div class="card">
          <div class="card-header" style="background-color:#B3F2FF;">
            <ul class="nav nav-tabs card-header-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link active" style="color:#000000;" aria-current="true" href="#">Agregar Matrícula</a>
              </li>
              <li class="nav-item">
          ...
          <form method="POST"> 
            ...
            <div class="card">
              <div class="card-header text-center" ><!-- TITULO ENCABEZADO DATOS PERSONALES -->
                <h1 class=" card-title text-center">Carga Académica Disponible</h1>
              </div>
              <div class="card-body">
                              ...
                              <div class="modal-content"><!-- Modal content-->
                                  ...
                                  <div class="modal-body"><!--CUERPO DEL MODAL -->
                                    ...
                                    <div class="row"><!-- INICIO PRIMERA ROW --> 
                                      ...
                                      <div class="col-sm-6">
                                        <div class="form-group">
                                          <label for="txtcodigo_persona">Nombre del Tutor</label>
                                  ...
                                  <div class="modal-footer ">
                                    ...
                                    <button type="submit"  name="AGREGAR_MATRICULA" style="color:white;"class="btn btn-primary"><span> <i class="nav-icon fa fa-plus-square mx-1"></i></span>Matricular</button>      
                                  </div><!--FIN DEL DIV DE BOTONES DE GUARDAR -->
                                </div>
                              </form>
                            </div>
                          </div><!--Fin modal Matricula -->  
                      </tr>             
                      </tbody>
                      <?php
                        }
          ...
          <div class="card">
            <div class="card-header text-center"><!-- TITULO ENCABEZADO DATOS PERSONALES -->
               <h1 class=" card-title text-center">Clases Matriculadas</h1>
            </div>
