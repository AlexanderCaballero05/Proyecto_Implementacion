                                                    ...
                                                    id="editar_cita<?php echo $var1 ?>" role="dialog"  >
                                                        <div class="modal-dialog modal-lg">
                                                            ...
                                                            <div class="row"> 
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        min="<?= date($fechaactual)?>"  max="<?= date($fechamaxima)?>" 
                                                                        class="form-control" 
                                                        ...
                                                        <!-- ------------------ FIN PRIMERA ROW editar---------------------- -->
                                                            <div class="modal-footer ">
                                                                ...
                                                                <button type="submit" name="edit_citaGenerales"  id = "edit_cita" class="btn btn-success"><span> <i class="nav-icon fas fa-save mx-1"></i></span>Guardar</button>
