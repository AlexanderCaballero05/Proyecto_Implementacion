        ...
        <div class="card">
          <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
              ...
              <li class="nav-item">
                <a class="nav-link " aria-current="true" href="procesoCargaAcademica">Carga academica</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="true" href="#"> Editar Carga </a><!--La pagina en la que nos encontramos -->
              </li>
            </ul>
          </div><!--FIN DEL CARD HEADER -->
          <div class="card-body"><!--Cuerpo del card body principal -->
            </br>
           <form id="formBuscarCarga"  method="POST">
               <div class="row mb-4">
                    ...
                    <!-- <button type="submit"  name="filtrartutor"  class="btn btn-info"><i style='font-size:18px' class='fas'>&#xf0d0;</i></button>-->
                    <button type="submit" class="btn btn-info"  name="filtrartutor" class="col-sm-1 col-form"><span> <i class="nav-icon fa fa-search mx-1"></i></span>Buscar Carga</button>  
               </div><!--AQUI TERMINARIA-->
           <?php
