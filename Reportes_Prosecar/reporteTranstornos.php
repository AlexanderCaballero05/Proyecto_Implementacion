...
// Cabecera de página
	...
	function Header() {
		...
		$this->SetX(70);
		$this->Cell(40, 12, utf8_decode('Reporte de Transtornos'));
		$this->SetX(5);
		$this->Ln(11);
...
$conexion=$data->conect(); 
  $strquery ="SELECT `CODIGO_TRANSTORNO`, `TIPO` FROM `tbl_transtornos_corporales`
  ORDER BY  CODIGO_TRANSTORNO ASC ;";
