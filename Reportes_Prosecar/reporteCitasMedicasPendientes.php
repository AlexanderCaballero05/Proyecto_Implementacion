...
// Cabecera de página
	...
	function Header() {
		...
		$this->SetX(120);
		$this->Cell(180, 8, utf8_decode('Reporte de Citas Pendientes'));
		$this->Ln(6);
		$this->SetX(5);
...
//------------------OBTENES LOS DATOS DE LA BASE DE DATOS-------------------------
  ...
  $conexion=$data->conect(); 
	$strquery ="SELECT a.CODIGO_AREA,  IC.CODIGO_CITA,IC.FECHA_CITA,IC.HORARIO , IC.CODIGO_PERSONA ,IC.CODIGO_ESPECIALISTA , CONCAT_WS(' ',P.PRIMER_NOMBRE, P.SEGUNDO_NOMBRE, P.PRIMER_APELLIDO,P.SEGUNDO_APELLIDO) AS 
	...
	AND E.CODIGO_PERSONA = '$codigo_MEDICO'
