...
<html lang="en">
  ...
  .pagenum:before {
    ...
    <title>Reporte Citas Psicológicas</title>
  </head>
  <body>
    <header>
    <img src="../Vistas/modulos/REPORTES/img/LOGO.jpg">
      ...
      <p  style="text-align: center; font-size: 18px;">Reporte de Citas Psicológicas del Estudiante</p>
   ...
   <main>
    ...
    <br>
    <fieldset>
      <legend>Datos de las Citas Psicológicas </legend>
    <br>
    <table>
      <thead>
         <tr>
