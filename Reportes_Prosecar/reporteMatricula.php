...
//------------------OBTENES LOS DATOS DE LA BASE DE DATOS-------------------------
  ...
  $conexion=$data->conect(); 
	$strquery ="SELECT  tma.CODIGO_MATRICULA, concat_ws (' ',tp.PRIMER_NOMBRE,' ',tp.PRIMER_APELLIDO) as ESTUDIANTE ,
    (select concat_ws (' ', tp2.PRIMER_NOMBRE,' ',tp.PRIMER_APELLIDO) from tbl_persona tp2
    where tca.CODIGO_PERSONA = tp2.CODIGO_PERSONA) as NOMBRE_TUTOR, tt.NOMBRE as ASIGNATURA, tm.TIPO as MODALIDAD ,te.GRADO_ACTUAL,tca.SECCION as SECCION,tca.HORA , tma.CREADO_POR_USUARIO, tma.FECHA_CREACION,tma.MODIFICADO_POR,tma.FECHA_MODIFICACION
