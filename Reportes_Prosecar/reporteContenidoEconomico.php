...
// Cabecera de página
	...
	function Header() {
		...
		$this->SetX(58);
		$this->Cell(45, 12, utf8_decode('Reporte Contenido Socieconómico'));
		$this->Ln(8);
		$this->SetX(5);
...
// --------------------METODO PARA ADAPTAR LAS CELDAS------------------------------
	...
	function CheckPageBreak($h, $setX) {
		...
		if ($this->GetY() + $h > $this->PageBreakTrigger) {
			...
			$this->Cell(80, 12, 'Tipo del Contenido Socioeconomico', 1, 0, 'C', 1);
			$this->Cell(130, 12, 'Nombre del Contenido Socioeconomico', 1, 1, 'C', 1);
...
//------------------OBTENES LOS DATOS DE LA BASE DE DATOS-------------------------
  ...
  $conexion=$data->conect(); 
	$strquery ="SELECT c.CODIGO_CONTENIDO_SOCIOECONOMICO, T.TIPO as TIPO, c.NOMBRE_TIPO 
	FROM tbl_contenido_socioeconomico c, tbl_tipo_socioeconomico t
    WHERE t.CODIGO_TIPOSOCIO = c.CODIGO_TIPOSOCIO
    ORDER BY  CODIGO_CONTENIDO_SOCIOECONOMICO ASC;";
