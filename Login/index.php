...
<head>
  ...
  <title>Parroquia Santa Teresa de Jesus </title>
    ...
    <div class="card-body login-card-body " >
      ...
      <form action="../Vistas/index.php" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" minlenght="5" maxlength="15" placeholder="Usuario">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" minlenght="8" maxlenght="20" placeholder="Password">
          <div class="input-group-append">
            <div class="input-group-text">
